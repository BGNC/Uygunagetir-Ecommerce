...
<ul>
<?php
	$resim	=	mysqli_query("SELECT * FROM slide ORDER BY id ASC",$baglanti);
...
<div class="vitrin">
	<?php
        $vitrinsql	=	mysqli_query("SELECT urun.urun_id,urun.urun_adi,urun.urun_resmi,deger.fiyat FROM urun,deger WHERE urun.vitrin=1 AND urun.urun_id=deger.urun_id",$baglanti);
