...
$urun=mysqli_fetch_array(mysqli_query($baglanti,"SELECT * FROM urun,deger WHERE urun.urun_id=$id AND urun.urun_id=deger.urun_id"));
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        ...
                        $markasql=@mysqli_query($baglanti,"SELECT * FROM marka ORDER BY marka_adi ASC");
                    ...
                    <div class="form-group">
                      ...
                      <?php
                        ...
                        $kategorisql=@mysqli_query($baglanti,"SELECT * FROM altkategori WHERE kategori_id=$urun[kategori_id] ORDER BY altkategori_adi ASC ");
